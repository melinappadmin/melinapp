...
export type Client = { id:string; name:string; contact_name:string|null; phone:string|null; address:string; neighborhood:string|null; city:string; state:string; latitude:number; longitude:number; current_stock:number; min_stock:number; active:boolean };
